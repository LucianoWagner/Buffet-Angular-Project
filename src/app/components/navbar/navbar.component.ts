...
import {
  TuiAppearance,
  TuiButton,
  TuiDataList, TuiDataListComponent,
  TuiDropdown, TuiDropdownDirective, TuiDropdownHover, TuiDropdownOpen,
  TuiDropdownService,
  TuiIcon, TuiOptGroup, TuiOption,
  TuiTextfield,
  TuiTitle,
} from '@taiga-ui/core';
import {
...
import {
  TuiAsideComponent, TuiAsideGroupComponent, TuiAsideItemDirective,
  TuiCardLarge,
  TuiDrawerDirective,
  TuiForm,
  TuiHeader, TuiHeaderComponent,
  TuiLogoComponent,
  TuiNavigation
...
@Component({
  ...
  imports: [RouterOutlet, FormsModule,
    ...
    TuiTabs,
    TuiTextfield,
    TuiTitle, TuiAsideComponent, TuiDrawerDirective, TuiOptGroup, TuiDataListComponent, TuiLogoComponent, TuiDropdownOpen, TuiDropdownDirective, TuiAsideItemDirective, TuiAsideGroupComponent, TuiDropdownHover, TuiOption, TuiHeaderComponent],
